...
function formatRp(cents: number | null): string {
  if (!cents) return '—';
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-64 rounded-[10px] border border-slate-200 py-[7px] pl-9 pr-3 text-[13px] text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
              ...
              <li key={o.id} className="rounded-[14px] border border-slate-200 bg-white px-5 py-4">
                ...
                <div className="mb-2 flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-0.5 text-xs text-slate-400">{ago}</div>
                  </div>
                </div>
